...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('qr.generate')); ?>" method="POST" enctype="multipart/form-data" id="qrForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        value="<?php echo e(old('url', $originalUrl ?? '')); ?>"
                        required
                    >
...
unset($__errorArgs, $__bag); ?>"
            ...
            <?php if($qrCode): ?>
                <div class="qr-result">
                    <img src="<?php echo e($qrCode); ?>" alt="Generated QR Code" class="qr-image">

                    <div class="url-display">
                        <span id="urlText" class="url-text"><?php echo e($originalUrl); ?></span>
                        <button type="button" class="btn btn-secondary copy-btn" data-copy-url="<?php echo e($originalUrl); ?>">
                            <i class="bi bi-clipboard"></i> Copy
                        </button>
                    </div>

                    <div class="btn-group-actions">
                        <a href="<?php echo e(route('qr.download')); ?>" class="btn btn-primary">
                            <i class="bi bi-download"></i> Download PNG
                        </a>
                        <a href="<?php echo e(route('qr.reset')); ?>" class="btn btn-secondary">
...
<?php /**PATH /home/codecps/Desktop/QR code Gen/resources/views/qr-generator.blade.php ENDPATH**/ ?>